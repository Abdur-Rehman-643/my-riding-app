...
const Home = () => {
  ...
  async function createRide() {
    ...
    try {
      ...
      // You can add additional logic here, e.g., update state, navigate, etc.
    } catch (error) {
      console.error(
        "Error creating ride:",
  ...
  return (
    <div className="h-screen relative overflow-hidden">
      <div className="h-screen relative overflow-hidden">
        {/* Fixed Top Bar */}
        <div className="fixed z-20 p-6 top-0 flex items-center justify-between w-screen bg-transparent">
